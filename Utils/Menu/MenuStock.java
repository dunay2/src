...
public class MenuStock extends MenuBase {
    ...
    static protected ArrayList<MenuStruct>  itemEntries(String parentMnuName) {
        ArrayList<MenuStruct> entries = new ArrayList();

        //1. mnuItem
        entries.add(new MenuStruct("mnuTransaction", "Buscar Producto"));
        entries.add(new MenuStruct("mnuTransaction", "Agregar Producto"));
        entries.add(new MenuStruct("mnuTransaction", "Actualizar Producto "));
        entries.add(new MenuStruct("mnuTransaction", "Listar Productos"));
        entries.add(new MenuStruct("mnuTransaction", "Eliminar Producto"));

        entries.add(new MenuStruct("mnuTransaction", "Volver al Menú Principal"));
     return entries;
    }
    ...
    static protected ArrayList<MenuStruct>  addItemEntries(String parentMnuName) {
        ...
        //5. mnuAddItem
        //Input menu
        entries.add(new MenuStruct("", "Introduzca código de familia: 1.  Ordenadores   2. Hogar   3. Telefonía   4. Imagen   5. Sonido"));
        entries.add(new MenuStruct("", "Introduzca código de artículo"));
        entries.add(new MenuStruct("", "Introduzca descripción de artículo"));
        entries.add(new MenuStruct("", "Introduzca precio de compra"));
        entries.add(new MenuStruct("", "Introduzca cantidad en stock"));
 ...
 return entries;
    ...
    static protected ArrayList<MenuStruct>  editItemEntries(String parentMnuName) {
        ...
        entries.add(new MenuStruct("", "Introduzca descripción de artículo"));
        entries.add(new MenuStruct("", "Introduzca precio de compra"));
        entries.add(new MenuStruct("", "Introduzca precio de venta"));
        entries.add(new MenuStruct("", "Introduzca cantidad en stock"));
...
//InputMnu
        //1. mnuItem
        entries.add(new MenuStruct("mnuTransaction", "Introduzca el código de artículo"));
    ...
    static protected ArrayList<MenuStruct>  searchItemEntries(String parentMnuName) {
        ...
        //Input mnu
        ArrayList<MenuStruct> entries = new ArrayList();
        entries.add(new MenuStruct("", "Introduzca el código de artículo"));
