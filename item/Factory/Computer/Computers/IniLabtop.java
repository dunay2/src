...
import item.family.computers.Labtop;
 ...
 * @author ashh412
 */
public class IniLabtop extends Labtop {

    public IniLabtop(String code) {
        super(code);
    }
     ...
     * @param response
     */
    public IniLabtop(String key, ArrayList<String> response) {
